...
<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInLeft;">
				...
				<li class="active">地址：${userAddress }</li>&nbsp;&nbsp;<a href="">修改地址</a>
			</ol>
		</div>
</div>
<!---->
<div class="container">
	<div class="check-out">
	    ...
	    <c:forEach items="${odList }" var="od" >
		  <tr>
			<td class="ring-in"><a href="single.html" class="at-in"><img src="../${od.img1 }" class="img-responsive" alt=""></a>
			<div class="sed">
				<h5>${od.getProduct().getProductId() }</h5>
				<p>(At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium) </p>
			</div>
			<div class="clearfix"> </div>
			</td>
				<td class="check">
			    	<input type="text" name="count" value="${od.count }">
				</td>		
			<td>${od.singleprice }</td>
			<td>${od.totalprice }</td>
		  </tr>
	    </c:forEach>
	...
	<center>
	    <span class="finalprice">总计：${finalprice }</span>
	    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    <a href="${ctx }/orders/payForOrders" class=" to-buy">付款</a>
	    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	</center>
