...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="../${pd.img1}">
			        <div class="thumb-image"> <img src="../${pd.img1}" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="../${pd.img2}">
			         <div class="thumb-image"> <img src="../${pd.img2}" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    <li data-thumb="../${pd.img3}">
			       <div class="thumb-image"> <img src="../${pd.img3}" data-imagezoom="true" class="img-responsive"> </div>
			    </li> 
			  </ul>
		</div>
	</div>	
<div class="col-md-7 single-top-in">
						<div class="single-para simpleCart_shelfItem">
							...
							<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>
								...
								<label  class="add-to item_price">${pd.singlePrice }</label>
							...
							<div class="available">
								...
								<a href="${ctx }/cart/addCart?productName=${pd.productName }&userName=${userName }" class="cart item_add">加入购物车</a>
						</div>
					</div>
			<div class="clearfix"> </div>
