...
<div class="products">
	<div class="container">
		...
		<div class="col-md-9">
            ...
            <div margin="5">
			<center>
			    <a href="${ctx }/products/pageList?pageNo=1">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
			    <a href="${ctx }/products/pageList?pageNo=${pageNo-1 }">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
			    <c:forEach begin="1" end="${pageCount }" step="1" var="i">
			        <a href="${ctx }/products/pageList?pageNo=${i }">${i }</a>&nbsp;&nbsp;&nbsp;&nbsp;
			    </c:forEach>
			    <a href="${ctx }/products/pageList?pageNo=${pageNo+1 }">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
			    <a href="${ctx }/products/pageList?pageNo=${pageCount }">尾页</a>
			</center>
			</div>
