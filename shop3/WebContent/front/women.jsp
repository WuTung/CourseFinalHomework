...
<div class="products">
	<div class="container">
		...
		<div class="col-md-9">
			...
			<div margin="5">
			<center>
			    <a href="${ctx }/products/selectByCondition?pageNo=1&typeId=1&pageName=women">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
			    <a href="${ctx }/products/selectByCondition?pageNo=${pageNo-1 }&typeId=1&pageName=women">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
			    <c:forEach begin="1" end="${TypePageCount }" step="1" var="i">
			        <a href="${ctx }/products/selectByCondition?pageNo=${i }&typeId=1&pageName=women">${i }</a>&nbsp;&nbsp;&nbsp;&nbsp;
			    </c:forEach>
			    <a href="${ctx }/products/selectByCondition?pageNo=${pageNo+1 }&typeId=1&pageName=women">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
			    <a href="${ctx }/products/selectByCondition?pageNo=${TypePageCount }&typeId=1&pageName=women">尾页</a>
			</center>
			</div>
			</div>	
		</div>
